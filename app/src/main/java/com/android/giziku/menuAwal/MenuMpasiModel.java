...
public class MenuMpasiModel implements Serializable {
    String judul;
    String keterangan;
    String img_url;
    String tanggal;
    ...
    public MenuMpasiModel(String judul, String keterangan, String img_url, String tanggal, String kategori, String funfact, String waktu_memasak, String bahan, String usia, String porsi, String cara_membuat) {
        this.judul = judul;
